...
internal class QuestionManager
{
    ...
    public async Task<List<Question>> FinalQuestionGenerator(string connectionString)
    {
        var questions = new List<Question>();

        questions.AddRange(await QuestionsByTeams(connectionString));
        questions.AddRange(await QuestionsByAttribute(connectionString));
        questions.AddRange(await QuestionByDraft(connectionString));
        questions.AddRange(await QuestionByHonor(connectionString));

        return questions;
    }

    public async Task<List<Question>> QuestionsByTeams(string connectionString)
    {
        var questions = new List<Question>();
    ...
    public async Task<List<Question>> QuestionsByAttribute(string connectionString)
    {
        var questions = new List<Question>();
        ...
        questions.Add(new Question
        {
            ...
            Query = $"SELECT * FROM players WHERE position = @'country'",
            NegQuery = $"SELECT * FROM players WHERE position != @'country'",
            Weight = 2,
        ...
        foreach (string letter in alphabet)
        {
            questions.Add(new Question
            {
                ...
                Weight = 3,
                Parameters = new Dictionary<string, object> { { "first_name", letter } }
            });//first name
            questions.Add(new Question
            {
                ...
                Weight = 3,
                Parameters = new Dictionary<string, object> { { "last_name", letter } }
            });//last name
        }//name starting
    ...
    public async Task<List<Question>> QuestionByHonor(string connectionString)
    {
        var questions = new List<Question>();
        ...
        foreach (string chip in championships)
        {
            questions.Add(new Question
            {
                ...
                Query = $"SELECT * FROM players WHERE id IN (SELECT player_id FROM players_honors WHERE honor_title = '@chip')",
                NegQuery = $"SELECT * FROM players p LEFT JOIN players_honors ph ON p.id = ph.player_id AND ph.honor_title = '@chip' WHERE ph.honor_title IS NULL",
                Weight = 2,
                Parameters = new Dictionary<string, object> { { "chip",  chip} }
            });//one chip
        ...
        foreach (string honor in singleTimeHonors)
        {
            questions.Add(new Question
            {
                ...
                NegQuery = $"SELECT * FROM players p LEFT JOIN players_honors ph ON p.id = ph.player_id AND ph.honor_title = '@honrTitle' WHERE ph.honor_title IS NULL",
                Weight = 3,
    ...
    public async Task<List<Question>> QuestionByDraft(string connectionString)
    {
        var questions = new List<Question>();
        ...
        await questions.Add(new Question
        {
